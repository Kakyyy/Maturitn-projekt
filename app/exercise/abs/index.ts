...
const ABS: Exercise[] = [{ id: 'abs-1', name: 'Crunches', equipment: 'Vlastní váha', primaryMuscles: ['abs'], difficulty: 'easy', instructions: ['Lehněte si na záda, pokrčte kolena a chodidla položte na zem.', 'Ruce dejte na hrudník nebo lehce za hlavu (netlačte hlavou dopředu).', 'Zpevněte břicho a lehce podsadťe pánev.', 'S výdechem zvedněte lopatky pár centimetrů nad zem a dívejte se šikmo ke kolenům.', 'Chvilku zatněte břicho a pomalu se vraťte zpět bez „plácnutí“.', 'Držte plynulé tempo a neprohýbejte bedra.'] },
  ...
  { id: 'abs-6', name: 'Abs Builder 6', equipment: 'Stroj', primaryMuscles: ['abs'], difficulty: 'easy', instructions: ['Nastavte výchozí pozici stroje.', 'Provádějte kontrolovaný pohyb v plném rozsahu.', 'Vracejte se pomalu bez trhání.', 'Držte stabilní trup a plynulý dech.'] },
  { id: 'abs-7', name: 'Abs Focus 7', equipment: 'Jednoručky', primaryMuscles: ['abs'], difficulty: 'medium', instructions: ['Zvolte přiměřenou zátěž pro čistý pohyb.', 'Proveďte koncentrickou fázi s výdechem.', 'Excentrickou fázi zpomalte na 2 až 3 sekundy.', 'Po celou dobu držte techniku bez kompenzací.'] },
  { id: 'abs-8', name: 'Abs Builder 8', equipment: 'Stroj', primaryMuscles: ['abs'], difficulty: 'easy', instructions: ['Nastavte výchozí pozici.', 'Provádějte kontrolovaný pohyb.', 'Vracejte se pomalu bez trhání.', 'Držte stabilní trup a plynulý dech.'] },
  { id: 'abs-9', name: 'Abs Builder 9', equipment: 'Jednoručky', primaryMuscles: ['abs'], difficulty: 'medium', instructions: ['Nastavte výchozí pozici.', 'Provádějte kontrolovaný pohyb.', 'Vracejte se pomalu bez trhání.', 'Držte stabilní trup a plynulý dech.'] },
];
