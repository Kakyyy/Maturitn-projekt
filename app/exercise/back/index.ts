...
const BACK: Exercise[] = [{ id: 'back-1', name: 'Deadlift', equipment: 'Činka', primaryMuscles: ['back'], difficulty: 'hard', instructions: ['Postavte se na šířku boků, činka nad středem chodidel.', 'Chyťte osu, zpevněte střed těla a srovnejte záda do neutrálu.', 'Zatlačte chodidly do země a zvedejte činku s osou co nejblíž u těla.', 'V horní pozici se narovnejte bez zbytečného záklonu.', 'Spouštějte kontrolovaně zpět dolů stejnou dráhou.', 'Pokud se vám kulatí záda, snižte váhu nebo rozsah.'] },
  ...
  { id: 'back-6', name: 'Back Builder 6', equipment: 'Stroj', primaryMuscles: ['back'], difficulty: 'easy', instructions: ['Nastavte výchozí pozici stroje.', 'Provádějte kontrolovaný pohyb v plném rozsahu.', 'Vracejte se pomalu bez trhání.', 'Držte stabilní trup a plynulý dech.'] },
  { id: 'back-7', name: 'Back Focus 7', equipment: 'Jednoručky', primaryMuscles: ['back'], difficulty: 'medium', instructions: ['Zvolte přiměřenou zátěž pro čistý pohyb.', 'Proveďte koncentrickou fázi s výdechem.', 'Excentrickou fázi zpomalte na 2 až 3 sekundy.', 'Po celou dobu držte techniku bez kompenzací.'] },
  { id: 'back-8', name: 'Back Builder 8', equipment: 'Stroj', primaryMuscles: ['back'], difficulty: 'easy', instructions: ['Nastavte výchozí pozici.', 'Provádějte kontrolovaný pohyb.', 'Vracejte se pomalu bez trhání.', 'Držte stabilní trup a plynulý dech.'] },
  { id: 'back-9', name: 'Back Builder 9', equipment: 'Jednoručky', primaryMuscles: ['back'], difficulty: 'medium', instructions: ['Nastavte výchozí pozici.', 'Provádějte kontrolovaný pohyb.', 'Vracejte se pomalu bez trhání.', 'Držte stabilní trup a plynulý dech.'] },
];
