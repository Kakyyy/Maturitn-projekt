...
const DELTOIDS: Exercise[] = [{ id: 'deltoids-1', name: 'Overhead Press', equipment: 'Činka', primaryMuscles: ['deltoids'], difficulty: 'medium', instructions: ['Postavte se na šířku boků a činku držte v úrovni klíčních kostí.', 'Zpevněte břicho a hýždě, žebra držte „dole“.', 'S výdechem tlačte činku přímo nad hlavu a hlavu lehce posuňte dopředu pod osu.', 'Nahoře držte lokty plně propnuté bez přehnaného prohnutí v bedrech.', 'Kontrolovaně spouštějte činku zpět na ramena.', 'Pokud vás bolí ramena, zkraťte rozsah nebo snižte váhu.'] },
  ...
  { id: 'deltoids-6', name: 'Deltoids Builder 6', equipment: 'Stroj', primaryMuscles: ['deltoids'], difficulty: 'easy', instructions: ['Nastavte výchozí pozici stroje.', 'Provádějte kontrolovaný pohyb v plném rozsahu.', 'Vracejte se pomalu bez trhání.', 'Držte stabilní trup a plynulý dech.'] },
  { id: 'deltoids-7', name: 'Deltoids Focus 7', equipment: 'Jednoručky', primaryMuscles: ['deltoids'], difficulty: 'medium', instructions: ['Zvolte přiměřenou zátěž pro čistý pohyb.', 'Proveďte koncentrickou fázi s výdechem.', 'Excentrickou fázi zpomalte na 2 až 3 sekundy.', 'Po celou dobu držte techniku bez kompenzací.'] },
  { id: 'deltoids-8', name: 'Deltoids Builder 8', equipment: 'Stroj', primaryMuscles: ['deltoids'], difficulty: 'easy', instructions: ['Nastavte výchozí pozici.', 'Provádějte kontrolovaný pohyb.', 'Vracejte se pomalu bez trhání.', 'Držte stabilní trup a plynulý dech.'] },
  { id: 'deltoids-9', name: 'Deltoids Builder 9', equipment: 'Jednoručky', primaryMuscles: ['deltoids'], difficulty: 'medium', instructions: ['Nastavte výchozí pozici.', 'Provádějte kontrolovaný pohyb.', 'Vracejte se pomalu bez trhání.', 'Držte stabilní trup a plynulý dech.'] },
];
