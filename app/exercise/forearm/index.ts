...
const FOREARM: Exercise[] = [
  { id: 'forearm-1', name: 'Wrist Curls', equipment: 'Činka', primaryMuscles: ['forearm'], difficulty: 'easy', instructions: ['Sedněte si a předloktí opřete o stehna nebo lavičku, dlaně směřují nahoru.', 'Činku držte lehce v prstech a nechte zápěstí klesnout do protažení.', 'Zvedejte zápěstí nahoru bez pohybu v lokti.', 'Nahoře krátce zatněte předloktí.', 'Pomalu spusťte zpět dolů do plného rozsahu.', 'Použijte lehkou váhu a dělejte plynulé opakování.'] },
