...
const GLUTEAL: Exercise[] = [{ id: 'gluteal-1', name: 'Hip Thrust', equipment: 'Lavice, činka', primaryMuscles: ['gluteal'], difficulty: 'medium', instructions: ['Opřete horní část zad o lavičku a činku položte přes pánev (použijte podložku).', 'Chodidla dejte na šířku boků a zpevněte břicho.', 'S výdechem tlačte boky vzhůru tak, aby trup byl v horní pozici zhruba vodorovně.', 'V horní pozici krátce zatněte hýždě a lehce podsadťe pánev.', 'Pomalu spouštějte dolů do výchozí pozice bez „padnutí“.', 'Kolenům držte směr ven (nebojte se je lehce tlačit od sebe).'] },
  ...
  { id: 'gluteal-6', name: 'Gluteal Builder 6', equipment: 'Stroj', primaryMuscles: ['gluteal'], difficulty: 'easy', instructions: ['Nastavte výchozí pozici stroje.', 'Provádějte kontrolovaný pohyb v plném rozsahu.', 'Vracejte se pomalu bez trhání.', 'Držte stabilní trup a plynulý dech.'] },
  { id: 'gluteal-7', name: 'Gluteal Focus 7', equipment: 'Jednoručky', primaryMuscles: ['gluteal'], difficulty: 'medium', instructions: ['Zvolte přiměřenou zátěž pro čistý pohyb.', 'Proveďte koncentrickou fázi s výdechem.', 'Excentrickou fázi zpomalte na 2 až 3 sekundy.', 'Po celou dobu držte techniku bez kompenzací.'] },
  { id: 'gluteal-8', name: 'Gluteal Builder 8', equipment: 'Stroj', primaryMuscles: ['gluteal'], difficulty: 'easy', instructions: ['Nastavte výchozí pozici.', 'Provádějte kontrolovaný pohyb.', 'Vracejte se pomalu bez trhání.', 'Držte stabilní trup a plynulý dech.'] },
  { id: 'gluteal-9', name: 'Gluteal Builder 9', equipment: 'Jednoručky', primaryMuscles: ['gluteal'], difficulty: 'medium', instructions: ['Nastavte výchozí pozici.', 'Provádějte kontrolovaný pohyb.', 'Vracejte se pomalu bez trhání.', 'Držte stabilní trup a plynulý dech.'] },
];
